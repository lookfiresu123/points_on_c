...
#include<stdlib.h>
#include<string.h>
#define MAX_COLS 20 //字面值常量，不能在 = 的左边
#define MAX_INPUT 1000 //同上
 ...
 * */
void rearrange(char *output,char const *input,int n_columns,int const columns[]){ //const 表示函数不会修改其对应的变量
    int col;
    int output_col;
    int len;
